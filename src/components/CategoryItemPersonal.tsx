...
export const CategoryItemPersonal: React.FunctionComponent = () =>{
    return(
        <div className="w-[164px] h-[164px] relative">
            ...
            <div className="w-[23.27px] h-[28.81] left-[127.43px] top-[121.89px] absolute text-custom-black text-xl font-medium breakwords">10</div>
            <BiCategory className="w-[44.32px] h-[44.32px] left-[13.30px] top-[8.86px] absolute text-custom-white" />
