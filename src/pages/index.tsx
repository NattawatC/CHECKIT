  ...
  return (
    ...
    <MainLayout className=' bg-black'>
      <div className=' flex flex-col items-center gap-9' >
        ...
        <Button className='bg-orange-600 text-white'>Get Started</Button>
      </div>
    </MainLayout>
    ...
    <MainLayout className=' bg-black'>
        <div className=' flex flex-col items-center gap-9' >
          ...
          <p className='text-white text-center text-base'>Qorem ipsum dolor sit amet, consectetur adipiscing elit. 
          Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus 
          sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat 
          lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</p>
        </div>
    </MainLayout>
    ...
    <MainLayout>
      <div className='flex flex-col items-center gap-6'>
        ...
        <p className='text-base text-center flex flex-row'>
          Use the shortest possible time to create tasks, use all the free features to make the most of them.
        </p>
